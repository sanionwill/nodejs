!(function () {
  ...
  function d(n) {
    try {
      var e = { shouldTrackUrlChange: this.shouldTrackUrlChange };
  ...
  (d.prototype = {
    ...
    handleUrlChange: function (t) {
      ...
      setTimeout(function () {
        var n = i.path,
          e = i.getPath();
        i.opts.shouldTrackUrlChange(e, n) &&
          n !== e &&
          ((i.path = e), t && i.sendPageview(e, n));
      }, 0);
    },
    sendPageview: function (n, e) {
      (window._hmt = window._hmt || []),
        window._hmt.push(["_trackPageDuration"]),
        window._hmt.push(["_setReferrerOverride", e]),
    ...
    proxy: function (n, e, t) {
      ...
      n[e] = function () {
        i.apply(n, arguments),
          o(t, "Function") && t(Array.prototype.slice.call(arguments));
      };
    },
  }),
    (i = "UrlChangeTracker"),
    (r = d),
    (window._hmt = window._hmt || []),
    window._hmt.push(["_providePlugin", i, r]);
})();
