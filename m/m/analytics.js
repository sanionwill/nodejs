  ...
  var z = /:[0-9]+$/,
    B = function (a, b) {
      ...
      if ("protocol" === b || "port" === b)
        a.protocol = A(a.protocol) || A(u.location.protocol);
      "port" === b
        ? (a.port = String(
      ...
      switch (b) {
        ...
        case "path":
          ...
          a = a.split("/");
          a: if (((b = []), (c = a[a.length - 1]), Array.prototype.indexOf))
            (b = b.indexOf(c)), (b = "number" == typeof b ? b : -1);
          else {
...
*/
  ...
  var F = window.GoogleAnalyticsObject,
    H;
  if ((H = void 0 != F)) H = -1 < (F.constructor + "").indexOf("String");
  var wa;
  if ((wa = H)) {
    var ha = window.GoogleAnalyticsObject;
    wa = ha ? ha.replace(/^[\s\xa0]+|[\s\xa0]+$/g, "") : "";
  }
  var gb = wa || "ga",
    jd = /^(?:utma\.)?\d+\.\d+$/,
    kd = /^amp-[\w.-]{22,64}$/,
  ...
  var Sd = function (a) {
    if (!a.get("dcLoaded") && "cookie" == a.get(ac)) {
      ...
      se(a) &&
        ...
        a.set(ad, "d", !0),
        J(79),
        a.set(qe, { U: re(a, 1), google: re(a, 2), V: void 0, count: 0 }, !0));
    }
  };
  var Lc = function () {
  ...
  var td = function (a, b) {
      ...
      if (
        ...
        if ((c && e && J(36), a.get(bc) || ye(a.get(Kd)))) {
          e &&
            (J(38), a.data.set(Q, e), d._gid && (J(51), a.data.set(I, d._gid)));
          g
    ...
    y = function (a, b, c, d, e) {
      if (!ea(Yd.get(b)) && !$d.get(b)) {
        ...
        if (p.test(b)) {
          ...
          c = a.model;
          var g = d || {};
          d = { id: b, type: 1, B: g.dataLayer || "dataLayer", G: !1 };
          c.get("&gtm") == b && (d.G = !0);
          d.ia = !!c.get("anonymizeIp");
          d.sync = e;
          var ca = String(c.get("name"));
          "t0" != ca && (d.target = ca);
          G(String(c.get("trackingId"))) ||
            ((d.clientId = String(c.get(Q))),
            (d.ka = Number(c.get(n))),
            (g = g.palindrome ? r : q),
            (g = (g = M.cookie.replace(/^|(; +)/g, ";").match(g))
              ? g.sort().join("").substring(1)
              : void 0),
            (d.la = g),
            (d.qa = E(P(c, kb), "gclid")));
          He(d);
              ...
              (a = (a =
                ...
                e
                  ? ((e = ""),
                    ...
                    f.test(l) &&
                      M.write("<script" + e + ' src="' + l + '">\x3c/script>'))
